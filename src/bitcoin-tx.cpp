...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " " PACKAGE_NAME "-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  " + PACKAGE_NAME + "-tx [options] <hex-tx> [commands]  Update hex-encoded " + PACKAGE_NAME + " transaction\n" +
            "or:     " + PACKAGE_NAME + "-tx [options] -create [commands]   Create hex-encoded " + PACKAGE_NAME + " transaction\n" +
            "\n";
