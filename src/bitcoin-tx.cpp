...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " " + lowerAppName + "-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  " + lowerAppName + "-tx [options] <hex-tx> [commands]  Update hex-encoded " + PACKAGE_NAME + " transaction\n" +
            "or:     " + lowerAppName + "-tx [options] -create [commands]   Create hex-encoded " + PACKAGE_NAME + " transaction\n" +
            "\n";
