# Bootstrappable Vericoin Builds

This directory contains the files necessary to perform bootstrappable Vericoin builds.
...
- 24GB of free disk space on the partition that the Vericoin git repository
  resides in
...
For a Vericoin depends development environment, simply invoke
...
From the top of a clean Vericoin repository:
...
To use dongcarl's substitute server for Vericoin builds after having
