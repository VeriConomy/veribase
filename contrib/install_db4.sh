...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the verium/vericoin repository."
  exit 1
fi
...
echo 'When compiling vericoind/veriumd, run `./configure` in the following way:'
echo
