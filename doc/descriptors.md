# Support for Output Descriptors in Veribase

Since Veribase v0.17, there is support for Output Descriptors. This is a
...
on Veribase's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Veribase Core wallets, a convenience function `combo` is
...
All RPCs in Veribase will include the checksum in their output. Only
