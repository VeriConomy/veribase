...
By default, Veribase allows up to 125 connections to different peers, 10 of
...
limits are tiny. Keep in mind that veribase's trustless model works best if you are
