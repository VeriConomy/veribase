# Fuzzing Veribase using libFuzzer

## Quickstart guide

To quickly get started fuzzing Veribase using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):

```sh
$ git clone https://github.com/VeriConomy/veribase
$ cd veribase/
$ ./autogen.sh
